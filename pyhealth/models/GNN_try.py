...
"""
Mettere qualche funzione per la GRAPH DEFINITION
"""
...
class GNNtry(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(GNNtry, self).__init__(
            dataset=dataset,
            feature_keys=["conditions", "procedures","symptoms"], #modificato
            label_key="drugs",
            mode="multilabel",
        )

        """
        Mettere roba del modello Class ModelGNN ???????
        """
